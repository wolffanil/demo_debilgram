...
function Profile({ ver }: { ver: version }) {
  const user: UserType = {
    name: "Dfdvv",
    username: "ddfdfd",
    id: 4545,
    ...
    online: true,
    bio: "dfsjdfljslkfjlsjfljsljfjsfnvlsdnvnsldknvnsdlnvns",
  };
  return (
    <StyleProfile>
      <ProfileHeader>
      ...
      <ProfileWrapper>
        <img src={user.img} alt="profile" className="profile__img" />
      ...
      {ver !== "myProfile" && <ProfileButton> Написать</ProfileButton>}
    </StyleProfile>
  );
}
